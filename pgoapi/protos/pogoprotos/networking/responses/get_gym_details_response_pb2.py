...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[pogoprotos_dot_data_dot_gym_dot_gym__state__pb2.DESCRIPTOR,pogoprotos_dot_data_dot_raid_dot_event__info__pb2.DESCRIPTOR,])
...
_GETGYMDETAILSRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='event_info', full_name='pogoprotos.networking.responses.GetGymDetailsResponse.event_info', index=7,
...
_GETGYMDETAILSRESPONSE.fields_by_name['event_info'].message_type = pogoprotos_dot_data_dot_raid_dot_event__info__pb2._EVENTINFO
